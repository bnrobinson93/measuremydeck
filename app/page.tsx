    ...
    <>
      ...
      >
        <section className="relative max-w-2xl px-5 py-6 sm:mx-auto sm:px-6 lg:mx-5">
          <div className="absolute left-96 top-32 h-96 w-96 rounded-full bg-indigo-500 opacity-20 blur-3xl" />
          <div className="absolute right-48 top-8 h-96 w-96 rounded-full bg-amber-500 opacity-20 blur-3xl" />
